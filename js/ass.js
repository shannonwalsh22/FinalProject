...
//Homework1/index.html
	$("li").click(function(){
		...
		switch( myID ){
			case "hw1":
				window.location.href='Homework1/index.html';
				break;
			case "hw2":
				window.location.href='Homework2/index.html';
				break;
			case "hw3":
				window.location.href='Homework3/index.html';
				break;
			case "hw5":
				window.location.href='Homework5/index.html';
				break;
			case "hw6":
				window.location.href='Homework6/index.html';
				break;
			case "hw8":
				window.location.href='Homework8/index.html';
				break;
			case "hw9":
				window.location.href='Homework9/index.html';
				break;
		}
